...
public class NaceApplicationConstants {
    ...
    public static final String FILE_CANNOT_BE_EMPTY_ERR_MSG = "Value of request param named 'file' cannot be empty";
    ...
    public static final String FILE_VALIDATION_ERROR_MSG = FILE_CANNOT_BE_EMPTY_ERR_MSG + " or " + INVALID_CSV_EXTENSIONS_ERR_MSG;
